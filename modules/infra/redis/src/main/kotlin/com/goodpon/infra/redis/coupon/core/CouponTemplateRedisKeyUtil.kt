...
object CouponTemplateRedisKeyUtil {
    ...
    const val COUPON_RESERVED_ZSET_KEY_PREFIX = "coupon:reserved:"
    const val COUPON_ISSUED_SET_KEY_PREFIX = "coupon:issued:"
    const val COUPON_REDEEMED_SET_KEY_PREFIX = "coupon:redeemed:"

    fun buildReservedZSetKey(couponTemplateId: Long): String {
        return "$COUPON_RESERVED_ZSET_KEY_PREFIX$couponTemplateId"
    }
