...
object CouponTemplateFactory {
    ...
    fun create(
        ...
        val errors = mutableListOf<CouponTemplateCreationErrorDetail>()
        ...
        if (errors.isNotEmpty()) {
            throw CouponTemplateCreationException(errors)
        }
    ...
    private fun addCouponRedemptionConditionErrors(
        errors: MutableList<CouponTemplateCreationErrorDetail>,
        ...
        redemptionCondition.validate().onFailure { exception ->
            when (exception) {
                is CouponRedemptionConditionInvalidMinOrderAmountException -> {
                    val errorDetail = CouponTemplateCreationErrorDetail(
