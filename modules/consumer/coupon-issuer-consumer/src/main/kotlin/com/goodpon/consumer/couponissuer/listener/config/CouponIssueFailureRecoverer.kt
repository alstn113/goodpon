...
class CouponIssueFailureRecoverer(
    ...
    private val markCouponIssueFailedUseCase: MarkCouponIssueFailedUseCase,
    ...
    override fun accept(record: ConsumerRecord<*, *>, exception: Exception) {
        try {
            ...
            markCouponIssueFailedUseCase(couponTemplateId = command.couponTemplateId, userId = command.userId)
        } catch (e: Exception) {
