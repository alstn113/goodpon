...
interface CouponTemplateJpaRepository : JpaRepository<CouponTemplateEntity, Long> {
    ...
    @Query(
        """
        SELECT new com.goodpon.infra.jpa.repository.dto.CouponTemplateSummaryDto(
            couponTemplate.id,
            couponTemplate.name,
    ...
    @Query(
        """
        SELECT new com.goodpon.infra.jpa.repository.dto.CouponTemplateDetailWithStatsDto(
            couponTemplate.id,
    ...
    @Query(
        """
        SELECT new com.goodpon.infra.jpa.repository.dto.CouponTemplateDetailDto(
            couponTemplate.id,
            couponTemplate.merchantId,
            couponTemplate.name,
            couponTemplate.description,
