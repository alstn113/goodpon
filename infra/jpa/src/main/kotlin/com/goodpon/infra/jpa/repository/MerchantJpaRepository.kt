...
import com.goodpon.infra.jpa.repository.dto.MyMerchantDetailSummaryDto
import com.goodpon.infra.jpa.repository.dto.MyMerchantSummaryDto
...
interface MerchantJpaRepository : JpaRepository<MerchantEntity, Long> {
    ...
    @Query(
        """
        SELECT new com.goodpon.infra.jpa.repository.dto.MyMerchantSummaryDto(
            merchant.id,
            merchant.name,
            merchant.createdAt
        )
    ...
    @Query(
        """
        SELECT new com.goodpon.infra.jpa.repository.dto.MyMerchantDetailSummaryDto(
            merchant.id,
            merchant.name,
            merchant.clientId,
            merchant.createdAt,
